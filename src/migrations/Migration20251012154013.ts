...
export class Migration20251012154013 extends Migration {
  ...
  override async up(): Promise<void> {
    ...
    this.addSql(`create table \`locations\` (\`id\` int unsigned not null auto_increment primary key, \`code\` varchar(255) not null, \`name\` varchar(255) not null, \`address\` varchar(255) not null, \`created_at\` datetime not null, \`updated_at\` datetime not null) default character set utf8mb4 engine = InnoDB;`);
    ...
    this.addSql(`create table \`classes\` (\`id\` int unsigned not null auto_increment primary key, \`class_name\` varchar(255) not null, \`class_code\` varchar(255) not null, \`department_id\` int unsigned not null, \`created_at\` datetime not null, \`updated_at\` datetime not null) default character set utf8mb4 engine = InnoDB;`);
    ...
    this.addSql(`create table \`role\` (\`id\` int unsigned not null auto_increment primary key, \`name\` varchar(255) not null, \`description\` varchar(255) not null, \`created_at\` datetime not null, \`updated_at\` datetime not null) default character set utf8mb4 engine = InnoDB;`);
    ...
    this.addSql(`create table \`rooms\` (\`id\` int unsigned not null auto_increment primary key, \`code\` varchar(255) not null, \`capacity\` int not null, \`type\` varchar(255) not null, \`is_active\` tinyint(1) not null default true, \`location_id\` int unsigned not null, \`created_at\` datetime not null, \`updated_at\` datetime not null) default character set utf8mb4 engine = InnoDB;`);
    ...
    this.addSql(`create table \`student\` (\`id\` int unsigned not null auto_increment primary key, \`student_code\` varchar(255) not null, \`first_name\` varchar(255) not null, \`last_name\` varchar(255) not null, \`date_of_birth\` datetime not null, \`gender\` varchar(255) not null, \`address\` varchar(255) not null, \`phone_number\` varchar(255) not null, \`user_id\` int unsigned null, \`classes_id\` int unsigned not null, \`created_at\` datetime not null, \`updated_at\` datetime not null) default character set utf8mb4 engine = InnoDB;`);
    ...
    this.addSql(`alter table \`student\` add index \`student_classes_id_index\`(\`classes_id\`);`);
    ...
    this.addSql(`create table \`student_course_registrations\` (\`id\` int unsigned not null auto_increment primary key, \`student_id\` int unsigned not null, \`course_id\` int unsigned not null, \`exam_session_id\` int unsigned not null, \`is_active\` tinyint(1) not null default true, \`created_at\` datetime not null, \`updated_at\` datetime not null) default character set utf8mb4 engine = InnoDB;`);
    ...
    this.addSql(`create table \`lecturer\` (\`id\` int unsigned not null auto_increment primary key, \`lecturer_code\` varchar(255) not null, \`first_name\` varchar(255) not null, \`last_name\` varchar(255) not null, \`date_of_birth\` datetime not null, \`gender\` varchar(255) not null, \`address\` varchar(255) not null, \`phone_number\` varchar(255) not null, \`user_id\` int unsigned null, \`department_id\` int unsigned null, \`is_supervisor\` tinyint(1) not null default false, \`created_at\` datetime not null, \`updated_at\` datetime not null) default character set utf8mb4 engine = InnoDB;`);
    ...
    this.addSql(`alter table \`student\` add constraint \`student_classes_id_foreign\` foreign key (\`classes_id\`) references \`classes\` (\`id\`) on update cascade;`);
  ...
  override async down(): Promise<void> {
    ...
    this.addSql(`alter table \`student\` drop foreign key \`student_classes_id_foreign\`;`);
